...
class Photos extends Component {
  ...
  render() {
    ...
    console.log(recentMealRecord ? recentMealRecord.findIndex(mealRecord => mealRecord.date == "2018-12-04") : "")
    let activeIndex = recentMealRecord ? recentMealRecord.findIndex(mealRecord => mealRecord.date == "2018-12-04") : ""
    return (
